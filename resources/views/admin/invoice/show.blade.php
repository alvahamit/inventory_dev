...
<div class="col-md-8 offset-md-2">
    <div class="tab-pane fade show active" id="invoice">
        ...
        <div class="row">
            <div class="col-md-6 float-left text-left"><strong>Invoice Date:</strong> {{$invoice->invoice_date}}</div>
            <div class="col-md-6 float-right text-right"><strong>Order #:</strong> {{$invoice->order_no}}</div>
        </div>
        <div class="row">
