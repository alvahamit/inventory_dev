<!-- 
    ...
    Document:   Invoice create blade for Samples.
...
@section('title', __('VSF-Sample'))

@section('logo', __('VSF Distribution'))

@section('pageheading', __('Create Invoice for Samples'))
        ...
        <div class="form-row col-md-12">
            ...
            <div class="form-group col-md-3 offset-md-6">
                ...
                <select class="custom-select custom-select-sm" name="invoice_type" id="invoice_type">
                    ...
                    <option value="1" disabled="disabled">Whole</option>
                    <option value="2" disabled="disabled">Partial</option>
                    <option value="3" selected="selected">Sample</option>
                </select>
            </div>
        </div>
        <div class="form-row col-md-12">
