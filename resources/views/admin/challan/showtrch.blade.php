<!-- 
    ...
    Document:   Transfer challan show blade.
    Model/Data: App\Challan
    Controller: ChallansController@showtrch
-->
...
<div class="col-md-8 offset-md-2">
    ...
    <div class="row">
        <div class="col-md-12">
            <form method="post" action="{{route('print.trch')}}" accept-charset="UTF-8">
                @csrf
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-6 float-left text-left"><strong>Challan Date:</strong> {{$challan->challan_date}}</div>
                <div class="col-md-6 float-right text-right"><strong>From:</strong>  {{ $challan->store_name }}</div>
            </div>
            <div class="row">
                <div class="col-md-6 float-left text-left">
                    ...
                    {{$challan->issued_by}}
                    @endif
                    <!--{!! str_replace('&#13;&#10;','<br>', config('constants.default_address')) !!}-->
                </div>
                <div class="col-md-6 float-right text-right"><strong>To:</strong> {{ $challan->to_store_name }}</div>
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row mt-5">
        <div class="col-md-12 float-left text-left">
