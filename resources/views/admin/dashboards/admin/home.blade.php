...
@include('admin.dashboards.admin.components.cards')

<div class="row">
    <!-- Area Chart -->
    @include('admin.dashboards.admin.components.area_chart')
    <!-- Pie Chart -->
    @include('admin.dashboards.admin.components.pie_chart')
</div>
...
<div class="row">
    ...
    <div class="col-lg-6 mb-4">
        ...
        @include('admin.dashboards.admin.components.project_card')

        <!-- Color System -->
        @include('admin.dashboards.admin.components.color_system')
    ...
    <div class="col-lg-6 mb-4">
        ...
        <!-- Illustrations -->
        @include('admin.dashboards.admin.components.illustration')

        <!-- Approach -->
        @include('admin.dashboards.admin.components.approach')
