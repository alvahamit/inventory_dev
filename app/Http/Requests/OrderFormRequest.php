...
class OrderFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        if($this->has('user_id')){
            return [
                ...
                'select_customer_address2' => 'required',
   ...
   public function messages()
   {
       return [
           ...
           'select_customer_address2.required' => 'Customer address line 2 is required.',
           'customer_address2.required' => 'Customer address line 2 is required',
           'customer_name_shipping.required' => 'Name required for shipping.',
           'shipping_company.required' => 'Company name required for shipping.',
           'shipping_address2.required' => 'Shipping address line 2 is required.',
